...
<div id="launchbox"><a id="launchtext" href="applet.php">Launch BiasViz</a>
</div>
<p id="notice">* requires Java 1.5 or greater (<a href="http://www.java.com/download">download here</a>). You will also need to accept a certificate so that the program can load your input files from your computer.</p>
...
<a href="http://sourceforge.net/"><img src="http://sflogo.sourceforge.net/sflogo.php?group_id=200141&amp;type=2" width="125" height="37" border="0" alt="SourceForge.net Logo" /></a>
</div>
</div>
</body>
</html>
